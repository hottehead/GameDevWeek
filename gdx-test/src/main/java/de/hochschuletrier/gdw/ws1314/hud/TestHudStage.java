...
public class TestHudStage extends AutoResizeStage {
	...
	public void init(AssetManagerX assetManager) {
		...
		VisualBar healthBarVisual =  new VisualBar(barTex, 30, 30, 300, 40, healthBar);
...
//		BarFrontDecorator frontBar = new BarFrontDecorator(test, frontBarTex);
		visualBar = new BarTextDecorator(backgroundHealth, new StaticTextElement(assetManager.getFont("verdana", 14), "100", 100, 0));
		visualBar = new BarFrontDecorator(visualBar, frontBarTex, new NinePatchSettings(1, 2, 2, 1));
