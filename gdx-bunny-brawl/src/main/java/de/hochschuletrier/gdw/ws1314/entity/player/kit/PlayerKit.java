...
public enum PlayerKit 
{
    ...
    NOOB(  EntityType.Noob, 	100.0f, 1, 	100.0f, 	0.0f, 	0.5f, 0.5f, new BasicAttack(), new BasicAttack()),
    HUNTER(EntityType.Hunter, 	120.0f, 1, 	80.0f, 		0.0f, 	0.5f, 0.5f, new AttackShootArrow(), new BasicAttack()),
    KNIGHT(EntityType.Knight, 	100.0f, 1, 	100.0f, 	0.0f, 	0.5f, 0.5f, new AttackSwingSword(), new BasicAttack()),
    TANK(  EntityType.Tank, 	80.0f,  3,  120.0f,		0.0f,	0.5f, 0.5f, new BasicAttack(), new BasicAttack());
